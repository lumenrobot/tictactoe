...
void PlayTicTacToe::startMove() {
  ...
  if (state == 8) {
   try {
	...
	//4 to 5
	POP = Position6D(PFhb.x,PFhb.y,PFhb.z,-0.358702f,0.346905f,-1.07784f);
  ...
  if (state == 5) {
   try {
	...
	//3 to 4
	POPrP = Position6D(0.189311f,-0.0638169f,0.251878f,0.140002f,0.0545704f,0.345666f);
	...
	//4 to 5
	POP = Position6D(PFhb.x,PFhb.y,PFhb.z,0.415829f,0.432471f,0.722689f);
	...
	//5 to 6
	POoP = Position6D(0.190263f,-0.0155359f,0.2666f,0.00665099f,-0.22796f,0.612004f);
  ...
  if (state == 4) {
   try {
	...
	angleL122 = LArmInverseHipBase(PosOrient2Matrix(POL122),angle0);
	POL123 = Position6D(0.152038f,0.10917f,0.342962f,0.203887f,-0.651306f,0.0439805f);
	angleL123 = LArmInverseHipBase(PosOrient2Matrix(POL123),angle0);
  ...
  if (state == 1) {
   try {
	...
	//2 to 3
	POPrG = POL123;
	POG = Position6D(PIhb.x,PIhb.y,PIhb.z,0.0520276f,0.617237f,0.0924543f);
	...
	//4 to 5
	POP = Position6D(PFhb.x,PFhb.y,PFhb.z,0.0155708f,0.498108f,-0.591502f);
  ...
  if (state == 2) {
   try {
	...
	//2 to 3
	POPrG = POL123;
	POG = Position6D(PIhb.x,PIhb.y,PIhb.z,-0.0818397f,0.623312f,-0.154035f);
	...
	//4 to 5
	POP = Position6D(PFhb.x,PFhb.y,PFhb.z,-0.149083f,0.347143f,-0.892745f);
  ...
  if (state == 3) {
   try {
	...
	//2 to 3
	POPrG = POR123;
	POG = Position6D(PIhb.x,PIhb.y,PIhb.z,0.0642417f,0.638399f,-0.133826f);
	...
	//4 to 5
	POP = Position6D(PFhb.x,PFhb.y,PFhb.z,0.161984f,0.602558f,0.465133f);
