...
namespace MultiFaceRec
{
    public partial class FrmPrincipal : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            wb.Navigate("file:///C:/Documents%20and%20Settings/Administrator/My%20Documents/Visual%20Studio%202010/Projects/NAOServer2/NAOServer2/NAOImageStringBase64.htm");
            Console.WriteLine(gethtml(wb));
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            //Image imgFromWs = Base64ToImage(ws.Receive());   //1-
            
            //Base64ToImage(ws.Receive);
            //currentFrame = new Image<Bgr, byte>(new Bitmap(imgFromWs)).Resize(320, 240, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
        ...
        //...
        private string gethtml(WebBrowser wb)
        {
            
            System.Windows.Forms.HtmlDocument docwb = wb.Document;
            String str = docwb.InvokeScript("getBase64String").ToString();
            
            //----Below is using getting string from html
            ...
            //return final;
            //----Above is using getting string from html
            return str;
        }
